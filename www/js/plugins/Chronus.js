...
(function () {
    ...
    var settings = {
        ...
        timeTone:[
            ...
            {timeId:0, value:[-60, -60, -50, 100]},
            {timeId:1, value:[-68, -68, 0, 0]},
            {timeId:2, value:[0, 0, 0, 0]},
            {timeId:3, value:[0, 0, 0, 0]},
            {timeId:4, value:[51, -34, -68, 102]},
            {timeId:5, value:[-68, -68, 0, 102]}
        ]
    };
    //=============================================================================
    // ユーザ書き換え領域 - 終了 -
    ...
    Game_Chronus.prototype.getWeekName = function () {
        ...
        return TS_Function.getLanguage('Week' + this.getWeekIndex());
    };
    ...
    Game_Chronus.prototype.getDateFormat = function(index) {
        ...
        format = format.replace(/DAY/gi, function() {
            return TS_Function.getLanguage('Day');
        }.bind(this));
        return format;
    };
