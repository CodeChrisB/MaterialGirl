...
Window_Options.prototype.addKeyConfigCommand = function() {
	...
	this.addCommand(TS_Function.getLanguage('KeyConfig'), 'keyConfig', true);
};
...
Window_KeyConfig.prototype.makeCommandList = function(index) {
		...
		this.addCommand(TS_Function.getLanguage('KeyConfigDefault'), 'default', true);
		for (var i = 0; i < 6; ++i) this.addCommand(' ', 'default', true);
		this.addCommand(TS_Function.getLanguage('KeyConfigLayout'), 'wasd', true);
		for (var i = 0; i < 6; ++i) this.addCommand(' ', 'wasd', true);
		this.addCommand(TS_Function.getLanguage('KeyConfigFinish'), 'cancel', true);
...
Window_KeyConfig.prototype.updateHelp = function() {
    if (!this._helpWindow) return;
		...
		case 'key':
			this._helpWindow.setText(TS_Function.getLanguage('KeyConfigHelp'));
			break;
		case 'default':
			this._helpWindow.setText(TS_Function.getLanguage('KeyConfigDefaultHepl'));
			break;
		case 'wasd':
			this._helpWindow.setText(TS_Function.getLanguage('KeyConfigLayoutHepl'));
			break;
		case 'cancel':
			this._helpWindow.setText(TS_Function.getLanguage('KeyConfigFinishHelp'));
			break;
		default:
...
Window_KeyAction.prototype.makeCommandList = function() {
	this.addCommand(TS_Function.getLanguage('KeyConfigButtonClear'), 'ok', true, 'clear');
	this.addCommand(TS_Function.getLanguage('KeyConfigButtonOk'), 'ok', true, 'ok');
	this.addCommand(TS_Function.getLanguage('KeyConfigButtonEsc'), 'ok', true, 'escape');
	this.addCommand(TS_Function.getLanguage('KeyConfigButtonCancel'), 'ok', true, 'cancel');
	this.addCommand(TS_Function.getLanguage('KeyConfigButtonMenu'), 'ok', true, 'menu');
	this.addCommand(TS_Function.getLanguage('KeyConfigButtonDash'), 'ok', true, 'shift');
	this.addCommand(TS_Function.getLanguage('KeyConfigButtonPageUp'), 'ok', true, 'pageup');
	this.addCommand(TS_Function.getLanguage('KeyConfigButtonPageDown'), 'ok', true, 'pagedown');
	this.addCommand(TS_Function.getLanguage('KeyConfigButtonLeft'), 'ok', true, 'left');
	this.addCommand(TS_Function.getLanguage('KeyConfigButtonUp'), 'ok', true, 'up');
	this.addCommand(TS_Function.getLanguage('KeyConfigButtonRight'), 'ok', true, 'right');
	this.addCommand(TS_Function.getLanguage('KeyConfigButtonDown'), 'ok', true, 'down');
};
